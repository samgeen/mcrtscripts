...
NOTE: THIS IS WAY TOO SLOW WITH LIKE 6M IONISED CELLS TO PROCESS
Sam Geen, March 2015
'''
...
class HIIRegionFinder(object):
    ...
    def _FindHIIRegions(self, cells):
        ...
        '''
        clumps = []
        while len(cells["xHII"]) > 0:
            print "Number of cells left:", len(cells["xHII"])
            print "HII REGION FINDING..."
            ...
            print "REGION FOUND!"
        print "DONE BUT NOW FIND REGION PROPERTIES"
        return clumps
