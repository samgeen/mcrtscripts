...
class ClusterSource(weltgeist.sources.AbstractSource):
    """
    Source of energy & photons based on a lookup table
    """
    def __init__(self,mass,metal,tbirth=0.0,radiation=True,wind=True,rotating=True,seed=1):
        """
        Constructor
        ...
        self._wind = wind
        self._star = stars.ClusterPrecomputed(mass,metal,rotating=rotating,seed=seed,maxtime_Myr = 130.0,dt_Myr=0.01)
