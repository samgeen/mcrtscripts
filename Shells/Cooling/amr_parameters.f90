module amr_parameters
  ...
  logical ::smbh=.false.
  logical ::agn=.false.
  logical ::cagn=.false.        ! AGN on cloud
...
! AGN feedback on Cloud terms
  logical  :: agn_mech=.false.
  logical  :: agn_rad=.false.
  real(dp) :: xc_agn=0.
  real(dp) :: yc_agn=0.
  real(dp) :: zc_agn=0.
  integer  :: dx_agn=0
  integer  :: dy_agn=0
  integer  :: dz_agn=0
  real(dp), dimension(1:7) :: agn_n_source=0.
  integer, dimension(1:7)  :: agn_src_group=1
  integer :: agn_nsource 
  real(dp) :: agn_dens=0.
  real(dp) :: agn_vx=0.
  real(dp) :: agn_vy=0.
