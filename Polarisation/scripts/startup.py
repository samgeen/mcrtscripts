...
ericsims = ["ERIC-WIND","ERIC-NOWIND"]
allsims = imf1sims + imf2sims + massivesims + ericsims
...
masssimfolder2 = mainsimfolder2+"64_AMUN_IMF2_M1e5/"
ericsimfolder_wind = "/local/hdd/stgeen0/MC_RT/69_AMUN_onestar/06_uvwindspress"
ericsimfolder_nowind = "/local/hdd/stgeen0/MC_RT/69_AMUN_onestar/X6_uvpress_nowind"
...
if numsims > 4:
    simfolders["MASS_05"] = masssimfolder2+"05_UVphoto+press+Wind"
